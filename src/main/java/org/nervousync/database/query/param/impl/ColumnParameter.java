...
@XmlRootElement(name = "column_parameter", namespace = "https://nervousync.org/schemas/query")
public final class ColumnParameter extends AbstractParameter<ColumnItem> {
    ...
    @Override
    public void setItemValue(ColumnItem itemValue) {
