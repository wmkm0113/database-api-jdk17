 ...
 */
@XmlType(name = "function_parameter", namespace = "https://nervousync.org/schemas/query")
@XmlRootElement(name = "function_parameter", namespace = "https://nervousync.org/schemas/query")
public final class FunctionParameter extends AbstractParameter<FunctionItem> {
    ...
    @Override
    public void setItemValue(FunctionItem itemValue) {
