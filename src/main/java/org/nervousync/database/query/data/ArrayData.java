...
package org.nervousync.database.query.data;
 ...
 */
@XmlType(name = "array_data", namespace = "https://nervousync.org/schemas/query")
@XmlRootElement(name = "array_data", namespace = "https://nervousync.org/schemas/query")
