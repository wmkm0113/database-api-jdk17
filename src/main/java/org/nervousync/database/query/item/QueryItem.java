 ...
 */
@XmlType(name = "query_item", namespace = "https://nervousync.org/schemas/query")
@XmlRootElement(name = "query_item", namespace = "https://nervousync.org/schemas/query")
...
public final class QueryItem extends AbstractItem {
	...
	/**
	 * <span class="en-US">Query information</span>
	 * <span class="zh-CN">查询信息</span>
	 */
	@XmlElement(name = "query_info", namespace = "https://nervousync.org/schemas/query")
