 ...
 */
package org.nervousync.database.beans.configs.sensitive;
...
public final class SensitiveConfig {
     ...
     */
    public static SensitiveConfig newInstance(final SensitiveType sensitiveType,
        ...
        return validate ? new SensitiveConfig(prefixLength, suffixLength) : null;
    }
